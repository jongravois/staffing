...
<div data-role="page" data-add-back-btn="true">
	...
	<div data-role="content">  
		...
		<div data-role="fieldcontain" style="width:100%;">	
			<label for="off_time_start">Time Away - FROM:</label><br><br>
				<label for="off_time_start_date">DATE</label>
				<input type="date" id="off_time_start_date" name="off_time_start_date" data-role="datebox" data-options='{"mode": "calbox"}'>
				<label for="off_time_start_time">TIME</label>
				<input name="off_time_start_time" id="off_time_start_time" type="datetime" data-role="datebox" data-options='{"mode": "timebox"}'>
		</div>

		<div data-role="fieldcontain">	
			<label for="off_time_end">Time Away - TO:</label><br><br>
				<label for="off_time_end_date">DATE</label>
				<input type="date" id="off_time_end_date" name="off_time_end_date" data-role="datebox" data-options='{"mode": "calbox"}'>
				<label for="off_time_end_time">TIME</label>
				<input name="off_time_end_time" id="off_time_end_time" type="datetime" data-role="datebox" data-options='{"mode": "timebox"}'>
		</div>
